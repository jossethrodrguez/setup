...
```bash 
  unzip commandlinetools-linux*.zip -d android-sdk;mv android-sdk ..; cd ~/android-sdk/cmdlinetools; mkdir ~/android-sdk/cmdlinetools/latest; mv * latest/; cd bin; ./sdkmanager "platform-tools"
```
then 
```bash 
